...
{
	header("location: auth.php?error=bad_email_format");
	exit;
}
...
if( empty($data) )
{
	header("location: auth.php?error=bad_email");
	exit;
}
...
{
	header("location: auth.php?error=bad_password");
	exit;
}
...
header("location: index.php?authentification_success");
exit;